...
from perception.common.ppdet_ops import ConvNorm
from perception.common.ppdet_name_adapter import NameAdapter
...
class ResNet(object):
    ...
    def _conv_norm(self,
        ...
        bn_name = self.prefix_name + bn_name if \
            self.prefix_name != '' else bn_name
...
class MobileNetV2(object):
    def __init__(self,
                 scale=1.0,
                 with_cls_output=False,
                 with_custom_conv1=False):
        self.scale = scale
        self.with_cls_output = with_cls_output
        self.with_custom_conv1 = with_custom_conv1
    ...
    def __call__(self, input):
        # conv1
        name = 'conv1_1'
        if self.with_custom_conv1:
            # NOTE: use new parameter name so that avoids the conflict with
            # pretrained weights.
            name = 'new_conv1_1'
